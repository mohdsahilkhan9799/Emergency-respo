...
import "./FooterPage.css"; // Importing the CSS file
    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          <img src="https://erfl.org/demo2025.3/img/logo.jpg" alt="Main Logo" className="footer-logo" />
          <h2 className="footer-title">Emergency Response & Fire Leadership</h2>
